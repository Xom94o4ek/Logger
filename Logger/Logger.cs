...
namespace Logger
{
    class Logger : ILog
    {
        ...
        const string FatalFile = "Fatal.txt";
        const string ErrorFile = "Error.txt";
        const string ErrorUniqFile = "UError.txt";
        const string WarningFile = "Warning.txt";
        const string WarningUniqFile = "UWarning.txt";
        const string InfoFile = "Info.txt";
        const string DebugFile = "Debug.txt";
        const string SystemInfoFile = "SInfo.txt";
        ...
        private string TextFormating(string nametype, Exception e)
        {
        ...
        private string TextFormating(string nametype, string message, Dictionary<object, object> properties)
        {
            string AllArgs = "";
